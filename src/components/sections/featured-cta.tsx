      ...
      <div className="max-w-4xl mx-auto relative">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
          <div className="text-center lg:text-left">
            {/* <span className=" font-sans text-accent text-sm tracking-widest font-bold uppercase mb-4 block">
              Stay Connected
            </span> */}
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-end">
            <input
              ...
              className="px-5 py-4 bg-white/10 border border-accent/20 rounded-lg text-black placeholder:text-black/40 focus:outline-none focus:border-accent w-full sm:w-72 transition-colors"
            />
            <button className="px-8 py-4 bg-accent text-foreground font-semibold rounded-lg hover:bg-accent/90 transition-all hover:scale-105">
              Register
            </button>
          </div>
        </div>
